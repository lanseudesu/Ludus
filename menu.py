...
#logo colors = maroon(L): #be0108, yellow(D): #fdca01, mustard/gold(S): #f2a61d, white: #ffffff
...
class App(ctk.CTk):
    def __init__(self):
        ...
        #self.config(bg="#be0108") # changes window bg color
        ...
        self.menu_bar.add_cascade(label="Settings", menu=self.settings_menu) #Settings Light mode or Dark Mode
