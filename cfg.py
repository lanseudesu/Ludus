...
cfg = {
    ...
    "<expr_tail>": [["<logic_op>", "<expr>"], 
                    ["λ"]],
    "<relat_expr>": [["<factor>", "<factor_tail>"]], 
    "<factor_tail>": [["<relat_op>", "<expr>"], 
                      ["<arith_op>", "<expr>"], 
                      ["λ"]],
   ...
   #jm 243-305
    ...
    "<fs_body>": [["<func_body>"],  ["λ"]],
    "<func_body>": [["generate", "id", "(", "<params>", ")", "{", "<func_stmts>", "}", "<func_body>"],
                    ["<struct_body>"]],
    "<struct_body>": [["<local_struct>", "<struct_body>"],
                      ["λ"]],
    "<func_stmts>": [["<common_stmts>", "<func_stmts>"], ["<recall_stmts>", "<func_stmts>"],
                     ["<if_stmt_func>", "<func_stmts>"], ["<flank_func>", "<func_stmts>"],
                     ["<looping_func>", "<func_stmts>"], ["λ"]],
    "<flank_func>": ["flank", "<expr>", "{", "choice", "<valdead>", "<valdead_recur>",
                     ":", "<flank_func_body>", "<resume_stmt>", "<choice_func_recur>", "}"],
    "<flank_func_body>": [["<main_stmts>", "<flank_func_recur>"], ["<recall_stmts>", "<flank_func_recur>"]],
    "<flank_func_recur>": [["<flank_func_body>"], ["λ"]],
    "<choice_func_recur>": [["choice", "<valdead>", "<valdead_recur>", ":", "<flank_func_body>", 
                             "<resume_stmt>", "<choice_func_recur>"], ["backup", ":", "<flank_func_body>"]],
    "<if_stmt_func>": ["if", "<expr>", "{", "<func_stmts>", "<cond_recur_func>", "}", "<else_elif_func>"],
    "<else_elif_func>": [["<else_stmt_func>"], ["<elif_stmt_func>"], ["λ"]],
    "<else_stmt_func>": ["else", "<expr>", "{", "<func_stmts>", "<cond_recur_func>", "}"],
    "<elif_stmt_func>": ["elif", "<expr>", "{", "<func_stmts>", "<cond_recur_func>", "}", "<else_elif_func>"],
    "<cond_recur_func>": [["<func_stmts>"], ["λ"]],
    ...
    "<loop_body_func>": ["<loop_stmts>", "<loop_body_recur>"],
    "<loop_stmts>": [["<if_func_loop>"], ["<common_stmts>"], ["<flank_func>"], 
                     ["<recall_stmts>"], ["<looping_func>"]],
    "<if_func_loop>": ["if", "<expr>", "{", "<func_loop_stmts>", "}", "<else_elif_func_loop>"],
    "<else_elif_func_loop>": [["<else_func_loop>"], ["λ"], ["<elif_func_loop>"]],
    "<else_func_loop>": ["else", "<expr>", "{", "<func_loop_stmts>", "}"],
    "<elif_func_loop>": ["elif", "<expr>", "{", "<func_loop_stmts>", "}", "<else_elif_func>"],
    "<func_loop_stmts>": [["<loop_stmts>", "<func_loop_recur>"], ["<loop_control>", "<func_loop_recur>"]],
    "<func_loop_recur>": [["<func_loop_stmts>"], ["λ"]
}
